...
("N_ACTIVE","getActiveNotifications"),
("G_ACTIVE","()[Landroid/service/notification/StatusBarNotification;"),
("N_GET_ID","getId"),
("G_GET_ID","()I"),
("N_CANCEL","cancel"),
("G_CANCEL","(I)V"),
("N_DEL_CHANNEL","deleteNotificationChannel"),
("G_DEL_CHANNEL","(Ljava/lang/String;)V"),
("N_VIBRATION","enableVibration"),
("G_ZV","(Z)V"),
("N_CATEGORY","setCategory"),
("G_STR_B","(Ljava/lang/String;)Landroid/app/Notification$Builder;"),
("S_CAT_MSG","msg"),
("N_GROUP","setGroup"),
("N_GROUP_SUMMARY","setGroupSummary"),
("N_GROUP_ALERT","setGroupAlertBehavior"),
("N_ONLY_ONCE","setOnlyAlertOnce"),
("S_GROUP","firn_msgs"),
("S_APP_TITLE","FirnChat"),
("S_SUMMARY_TEXT","Neue Nachrichten"),
("S_L_KEYED","notification posted for key"),
("S_L_CANCEL","notification cancelled for key"),
]
txt=""; offs=[]; off=0
for n,v in S:
