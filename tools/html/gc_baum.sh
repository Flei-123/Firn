#!/usr/bin/env bash
# tools/html/gc_baum.sh — Dauerlauf: echte DOM-Baeume, kein Wachstum.
#
...
# vollstaendige Baeume aus echtem HTML (lib/browser/soak_baum.fi) und prueft,
...
"$FIRNC" -o "$ARBEIT/soak" lib/browser/soak_baum.fi || exit 1
