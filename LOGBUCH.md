...
Gebaut: lib/firnc1/time.fi (689 Z. Interpreter nach comptime.rs-Vorbild), Parser liest comptime-Bloecke,
...
Bisektion mit Mini-Modulen + Instrumentierung (exit-Codes 101+, dann Zaehler-Prints in err.fi).
